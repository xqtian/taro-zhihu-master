      ...
      <View className='feed-item'>
        <View className='feed-source'>
          ...
          <View className='flex8'>
            <Text className='feed-source-txt'>{this.props.feed_source_name}
              {this.props.feed_source_txt}</Text>
          </View>
          <View className='flex1'><Text className='iconfont icon-more'></Text></View>
        </View>
